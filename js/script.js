...

{
    ...
    let characters = [ //カードデータのオブジェクト
            { image: 'images/23073305.jpg', namae: 'Yamaha', age: 38, likes: 2, desc: 'はじめまして！数あるプロフの中から見ていただきありがとうございます！はじめまして！数あるプロフの中から見ていただきありがとうございます！' },
            { image: 'images/rekishicard.jpg', namae: 'Honda', age: 48, likes: 3, desc: 'このまま年賀全部キミに届けて全部年賀for you納めたlove you love youキミに届けこのまま年賀全部キミに届けて全部年賀for you納めたlove you love youキミに届け' },
            ...
            { image: 'images/G-otacard.jpg', namae: 'Meguro', age: 67, likes: 18, desc: 'はじめまして、ニュータイプです。なんだろう、感じる……君も、ニュータイプなんだね？はじめまして、ニュータイプです。なんだろう、感じる……君も、ニュータイプなんだね？' },
            { image: 'images/ojisan06.jpg', namae: 'Motoguchi', age: 48, likes: 1, desc: 'はじめまして！(((o(*ﾟ▽ﾟ*)o)))訪問ありがとう(≧▽≦)僕と君の出会いに乾杯🍻なんちゃって(n*´ω`*n)はじめまして！(((o(*ﾟ▽ﾟ*)o)))訪問ありがとう(≧▽≦)僕と君の出会いに乾杯🍻なんちゃって(n*´ω`*n)' }
        ];
